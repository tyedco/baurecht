...
A few Pelican related things I always need to look up:

Internal links to another page or a tag::
        `Websites <{filename}starter.rst>`_
        `Migrations <{tag}migration>`_ 

        
.. image:: |filename|/images/hdd_filingcabinet.png
    :alt: harddrive vs filing cabinet

.. figure:: |filename|/images/rtree.jpg
    :alt: magic tree

    There are some magical places in the `Tararuas <https://www.google.co.nz/maps/place/40%C2%B059%2743.4%22S+175%C2%B017%2758.4%22E/@-40.99539,175.29956,476m/data=!3m2!1e3!4b1!4m2!3m1!1s0x0:0x0?hl=en>`_

Create a link to a static file:
(in pelicanconf.py: 
